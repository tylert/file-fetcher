...
def main():
    ...
    print(f'terraform-provider-local:')
    print(f'  release: {get_latest_semver_hashicorp(json.loads(r.text)["terraform-provider-local"]["versions"].keys())}')
    print(f'terraform-provider-tls:')
    print(f'  release: {get_latest_semver_hashicorp(json.loads(r.text)["terraform-provider-tls"]["versions"].keys())}')

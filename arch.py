...
def fetch_arch_release_files(iso):
    ...
    fetch_file('https://mirror.cedille.club/archlinux/iso/latest/{}.sig'.format(iso), '{}.sig'.format(iso))
    fetch_file('https://mirror.cedille.club/archlinux/iso/latest/{}'.format(iso), '{}'.format(iso))
